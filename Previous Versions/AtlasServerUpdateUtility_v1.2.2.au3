...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.2.2.exe
...
#AutoIt3Wrapper_Res_ProductVersion=v1.2.2
...
; All Servers
$aUtilVersion = "v1.2.2" ; (2019-02-22)
...
Func ReadUini($sIniFile, $sLogFile)
	...
	Global $aServerRedisConfig = IniRead($sIniFile, " --------------- GAME SERVER CONFIGURATION --------------- ", "Redis-server config file (must be in \AtlasTools\RedisDatabase dir) ###", $iniCheck)
...
Func UpdateIni($sIniFile)
	...
	IniWrite($sIniFile, " --------------- GAME SERVER CONFIGURATION --------------- ", "Redis-server config file (must be in \AtlasTools\RedisDatabase dir) ###", $aServerRedisConfig)
