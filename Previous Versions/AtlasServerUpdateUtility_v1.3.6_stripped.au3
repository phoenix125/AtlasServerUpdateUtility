...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.3.6.exe
...
#AutoIt3Wrapper_Res_ProductVersion=v1.3.6
...
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Checking for mod updates or new mods.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
...
Local $bReturn = False
SplashTextOn($aUtilName, " Mod " & $sMod & " update released or new mod." & @CRLF & "Downloading and installing mod update.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
Local $aModScript = @ScriptDir & "\AtlasModDownloader.exe  --modids " & $sMod & " --steamcmd """ & $sSteamCmdDir & """ --workingdir """ & $sServerDir & """"
If $xDebug Then
FileWriteLine($aLogFile, _NowCalc() & " [Mod] Mod " & $sMod & " update released or new mod found. Downloading and installing mod:" & $aModScript)
Else
...
Next
EndIf
FileWriteLine($aServerSummaryFile, @CRLF & "           AdminPassword: " & $aServerAdminPass & @CRLF & "              MaxPlayers: " & $aServerMaxPlayers & @CRLF & "     ReservedPlayerSlots: " & $aServerReservedSlots & @CRLF & "               Multihome: " & $aServerMultiHomeIP & @CRLF & "   Server Extra Commands: " & $aServerExtraCMD & @CRLF & " SteamCMD Extra Commands: " & $aSteamExtraCMD & @CRLF & "                Mod List: " & $aServerModList)
