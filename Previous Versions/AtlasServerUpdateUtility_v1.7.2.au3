...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.7.2.exe
#AutoIt3Wrapper_Outfile_x64=Builds\AtlasServerUpdateUtility_v1.7.2_64-bit(x64).exe
...
#AutoIt3Wrapper_Res_ProductVersion=v1.7.2
...
$aUtilVerStable = "v1.7.2" ; (2019-06-09)
$aUtilVerBeta = "v1.7.2" ; (2019-06-09)
...
;~ Local $aRunWizard = ReadUini($aIniFile, $aLogFile, True) ; Kim (Use Wizard?)
...
;~ 			$xServerNames[1] = "Setup Temp Server Name" ; Kim
;~ 		EndIf
	EndIf
