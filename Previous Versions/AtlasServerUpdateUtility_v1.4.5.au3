...
; All Servers
$aUtilVersion = "v1.4.5" ; (2019-03-12)
...
Func TraySendRCON()
	...
	;	$tMsg = ""
	If $aGridSomeDisable Then
		$tMB = MsgBox($MB_YESNOCANCEL, $aUtilName, "Send RCON command to ALL servers, including disabled ones in GridStartSelect?" & @CRLF & @CRLF & _
