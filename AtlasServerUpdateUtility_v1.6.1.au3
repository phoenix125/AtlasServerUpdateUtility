...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.6.1.exe
#AutoIt3Wrapper_Outfile_x64=Builds\AtlasServerUpdateUtility_v1.6.1_64-bit(x64).exe
...
#AutoIt3Wrapper_Res_ProductVersion=v1.6.1
...
$aUtilVerStable = "v1.6.1" ; (2019-05-19)
$aUtilVerBeta = "v1.6.1" ; (2019-05-19)
...
If $aUseKeepAliveYN = "yes" Then
	$tPID = IniRead($aUtilCFGFile, "CFG", "aKeepAlivePID", 99999)
	If Not ProcessExists($tPID) Then
		$tPID = WinGetProcess("[CLASS:AutoIt v3 GUI]", "AtlasServerUpdateUtilityKeepAlive")
		If $tPID < 1 Then $tPID = Run(@ScriptDir & "\AtlasServerUpdateUtilityKeepAlive.exe")
		IniWrite($aUtilCFGFile, "CFG", "aKeepAlivePID", $tPID)
	EndIf
EndIf
...
Func _RestartUtil($fExit = 1)         ; Thanks Yashied!  https://www.autoitscript.com/forum/topic/111215-restart-udf/
	...
	_Splash("Restarting utility. . .", 2000)
	Local $Pid
