...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.7.3.exe
#AutoIt3Wrapper_Outfile_x64=Builds\AtlasServerUpdateUtility_v1.7.3_64-bit(x64).exe
...
#AutoIt3Wrapper_Res_ProductVersion=v1.7.3
...
$aUtilVerStable = "v1.7.3" ; (2019-06-11)
$aUtilVerBeta = "v1.7.3" ; (2019-06-11)
...
;~ 		WinSetOnTop($wGridConfig, "", 1)
	Else
		...
		Local $gX = 0
		Local $gY = 40
		If $aServerGridTotal > 35 Then $gY += 40
		If $aServerGridTotal > 70 Then $gY += 40
		...
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		Global $G_T1_L_GridName = GUICtrlCreateLabel("", $gY + 36, 73, 786, 24)
		GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
		...
		GUICtrlSetFont(-1, 8, 800, 0, "MS Sans Serif")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Local $G_T1_G_LocalRemote = GUICtrlCreateGroup("", 372, 97, 129, 41)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
...
;~ 	$gParamTF_TF[1] = True
		...
		For $i = 0 To ($gParamTFMax - 1)
			...
			EndIf
		Next
		$Label14 = GUICtrlCreateLabel("XPMultiplier", 668, 281, 59, 17)
		GUICtrlSetState(-1, $GUI_DISABLE)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$Label15 = GUICtrlCreateLabel("TamingSpeedMultiplier", 668, 377, 111, 17)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$Input5 = GUICtrlCreateInput("XPMultiplier", 604, 281, 57, 21)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$Input13 = GUICtrlCreateInput("HarvestHealthMultiplier", 604, 305, 57, 21)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$Label20 = GUICtrlCreateLabel("TreasureGoldMultiplier", 668, 329, 109, 17)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$Input14 = GUICtrlCreateInput("TreasureGoldMultiplier", 604, 329, 57, 21)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$Button13 = GUICtrlCreateButton("Duplicate to ALL Grids", 844, 273, 131, 25)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$Button14 = GUICtrlCreateButton("Duplicate to Select Grids", 844, 305, 131, 25)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$Label28 = GUICtrlCreateLabel("PlayerCharacterHealthRecoveryMultiplier", 668, 353, 197, 17)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$Label29 = GUICtrlCreateLabel("HarvestHealthMultiplier", 668, 305, 113, 17)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$Label30 = GUICtrlCreateLabel("HarvestAmountMultiplier", 668, 401, 118, 17)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$Label31 = GUICtrlCreateLabel("ClampHomeServerXPLevel", 668, 425, 132, 17)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$Label33 = GUICtrlCreateLabel("NoDiscoveriesMaxLevelUps", 668, 449, 138, 17)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$Label35 = GUICtrlCreateLabel("SettlementFlagResourceUpkeepMultiplier", 668, 473, 199, 17)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$Label36 = GUICtrlCreateLabel("MatingIntervalMultiplier", 668, 497, 112, 17)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetState(-1, $GUI_DISABLE)
		GUICtrlCreateGroup("", -99, -99, 1, 1)
		GUICtrlSetState(-1, $GUI_DISABLE)
...
;~ 	HotKeySet("^f", "G_T2_H_Find")
		...
		$tX += $tW + 5
		Global $G_T2_B_RestartServers = GUICtrlCreateButton("Restart Servers", $tX, 105, $tW, 25)
		...
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		Global $G_T3_L_GridName = GUICtrlCreateLabel("", 76, 73, 802, 24)
		GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
		GUICtrlSetColor(-1, 0x800000)
		GUICtrlSetBkColor(-1, 0xFFFFFF)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Global $G_T3_L_GridNumber = GUICtrlCreateLabel("", 20, 73, 49, 24)
		GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
		GUICtrlSetColor(-1, 0x800000)
		GUICtrlSetBkColor(-1, 0xFFFFFF)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Global $G_T3_E_EditGame = GUICtrlCreateEdit("", 20, 137, 961, 449)
		GUICtrlSetOnEvent(-1, "G_T3_E_EditGame")
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		GUICtrlSetBkColor(-1, $cFWBackground)
		_GUICtrlEdit_SetLimitText(-1, 999999)
		Local $tX = 20, $tW = 50, $tGap = 25
		Global $G_T3_B_Save = GUICtrlCreateButton("Save", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Click to save file: A backup will be made.")
		GUICtrlSetOnEvent(-1, "G_T3_B_Save")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T3_B_Reset = GUICtrlCreateButton("Reset", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Reset Edit Window: Reload contents from file.")
		GUICtrlSetOnEvent(-1, "G_T3_B_Reset")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		Global $G_T3_B_Find = GUICtrlCreateButton("Find", $tX, 105, $tW, 25)
		GUICtrlSetState(-1, $GUI_DISABLE)
		GUICtrlSetOnEvent(-1, "G_T3_B_Find")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
;~ 	HotKeySet("^f", "G_T3_H_Find")
		$tX += $tW + 5
		Global $G_T3_B_Replace = GUICtrlCreateButton("Replace", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Replace Text: New Window Asks for Text to be Replaced With New Text.")
		GUICtrlSetOnEvent(-1, "G_T3_B_Replace")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 110
		Global $G_T3_B_ClipboardCopy = GUICtrlCreateButton("Copy to Clipboard", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Copy Edit Window To Clipboard")
		GUICtrlSetOnEvent(-1, "G_T3_B_ClipboardCopy")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T3_B_ClipboardPaste = GUICtrlCreateButton("Paste from Clipboard", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Replace Edit Window Content With Clipboard")
		GUICtrlSetOnEvent(-1, "G_T3_B_ClipboardPaste")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 75
		Global $G_T3_B_OpenFile = GUICtrlCreateButton("Open File", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Open This File With Your Default Windows Text Editor")
		GUICtrlSetOnEvent(-1, "G_T3_B_OpenFile")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T3_B_OpenFolder = GUICtrlCreateButton("Open Folder", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Open The Folder Containing This File in Windows Explorer")
		GUICtrlSetOnEvent(-1, "G_T3_B_OpenFolder")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 85
		Global $G_T3_B_RestartUtil = GUICtrlCreateButton("Restart Util", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Restart This Utility Program: Servers Will Remain Running")
		GUICtrlSetOnEvent(-1, "G_TA_B_RestartUtil")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetBkColor(-1, $cGGridButtonActive)
		$tX += $tW + 5
		Global $G_T3_B_RestartServers = GUICtrlCreateButton("Restart Servers", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Restart Servers: You will be asked whether to restart servers now OR use Remote Restart with announcements.")
		GUICtrlSetOnEvent(-1, "G_TA_B_RestartServers")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		; -------------------------------------------------------------------
		...
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		Global $G_T4_L_GridName = GUICtrlCreateLabel("", 76, 73, 802, 24)
		GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
		GUICtrlSetColor(-1, 0x800000)
		GUICtrlSetBkColor(-1, 0xFFFFFF)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Global $G_T4_L_GridNumber = GUICtrlCreateLabel("", 20, 73, 49, 24)
		GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
		GUICtrlSetColor(-1, 0x800000)
		GUICtrlSetBkColor(-1, 0xFFFFFF)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Global $G_T4_E_Edit = GUICtrlCreateEdit("", 20, 137, 961, 449)
		GUICtrlSetOnEvent(-1, "G_T4_E_Edit")
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		GUICtrlSetBkColor(-1, $cFWBackground)
		_GUICtrlEdit_SetLimitText(-1, 999999)
		Local $tX = 20, $tW = 50, $tGap = 25
		Global $G_T4_B_Save = GUICtrlCreateButton("Save", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Click to save file: A backup will be made.")
		GUICtrlSetOnEvent(-1, "G_T4_B_Save")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T4_B_Reset = GUICtrlCreateButton("Reset", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Reset Edit Window: Reload contents from file.")
		GUICtrlSetOnEvent(-1, "G_T4_B_Reset")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		Global $G_T4_B_Find = GUICtrlCreateButton("Find", $tX, 105, $tW, 25)
		GUICtrlSetState(-1, $GUI_DISABLE)
		GUICtrlSetOnEvent(-1, "G_T4_B_Find")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
;~ 	HotKeySet("^f", "G_T4_H_Find")
		$tX += $tW + 5
		Global $G_T4_B_Replace = GUICtrlCreateButton("Replace", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Replace Text: New Window Asks for Text to be Replaced With New Text.")
		GUICtrlSetOnEvent(-1, "G_T4_B_Replace")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 110
		Global $G_T4_B_ClipboardCopy = GUICtrlCreateButton("Copy to Clipboard", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Copy Edit Window To Clipboard")
		GUICtrlSetOnEvent(-1, "G_T4_B_ClipboardCopy")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T4_B_ClipboardPaste = GUICtrlCreateButton("Paste from Clipboard", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Replace Edit Window Content With Clipboard")
		GUICtrlSetOnEvent(-1, "G_T4_B_ClipboardPaste")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 75
		Global $G_T4_B_OpenFile = GUICtrlCreateButton("Open File", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Open This File With Your Default Windows Text Editor")
		GUICtrlSetOnEvent(-1, "G_T4_B_OpenFile")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T4_B_OpenFolder = GUICtrlCreateButton("Open Folder", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Open The Folder Containing This File in Windows Explorer")
		GUICtrlSetOnEvent(-1, "G_T4_B_OpenFolder")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 85
		Global $G_T4_B_RestartUtil = GUICtrlCreateButton("Restart Util", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Restart This Utility Program: Servers Will Remain Running")
		GUICtrlSetOnEvent(-1, "G_TA_B_RestartUtil")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetBkColor(-1, $cGGridButtonActive)
		$tX += $tW + 5
		Global $G_T4_B_RestartServers = GUICtrlCreateButton("Restart Servers", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Restart Servers: You will be asked whether to restart servers now OR use Remote Restart with announcements.")
		GUICtrlSetOnEvent(-1, "G_TA_B_RestartServers")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		; -------------------------------------------------------------------
		...
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		Global $G_T5_L_GridName = GUICtrlCreateLabel("", 76, 73, 802, 24)
		GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
		GUICtrlSetColor(-1, 0x800000)
		GUICtrlSetBkColor(-1, 0xFFFFFF)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Global $G_T5_L_GridNumber = GUICtrlCreateLabel("", 20, 73, 49, 24)
		GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
		GUICtrlSetColor(-1, 0x800000)
		GUICtrlSetBkColor(-1, 0xFFFFFF)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Global $G_T5_E_Edit = GUICtrlCreateEdit("", 20, 137, 961, 449)
		GUICtrlSetOnEvent(-1, "G_T5_E_Edit")
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		GUICtrlSetBkColor(-1, $cFWBackground)
		_GUICtrlEdit_SetLimitText(-1, 999999)
		Local $tX = 20, $tW = 50, $tGap = 25
		Global $G_T5_B_Save = GUICtrlCreateButton("Save", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Click to save file: A backup will be made.")
		GUICtrlSetOnEvent(-1, "G_T5_B_Save")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T5_B_Reset = GUICtrlCreateButton("Reset", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Reset Edit Window: Reload contents from file.")
		GUICtrlSetOnEvent(-1, "G_T5_B_Reset")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		Global $G_T5_B_Find = GUICtrlCreateButton("Find", $tX, 105, $tW, 25)
		GUICtrlSetState(-1, $GUI_DISABLE)
		GUICtrlSetOnEvent(-1, "G_T5_B_Find")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
;~ 	HotKeySet("^f", "G_T5_H_Find")
		$tX += $tW + 5
		Global $G_T5_B_Replace = GUICtrlCreateButton("Replace", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Replace Text: New Window Asks for Text to be Replaced With New Text.")
		GUICtrlSetOnEvent(-1, "G_T5_B_Replace")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 110
		Global $G_T5_B_ClipboardCopy = GUICtrlCreateButton("Copy to Clipboard", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Copy Edit Window To Clipboard")
		GUICtrlSetOnEvent(-1, "G_T5_B_ClipboardCopy")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T5_B_ClipboardPaste = GUICtrlCreateButton("Paste from Clipboard", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Replace Edit Window Content With Clipboard")
		GUICtrlSetOnEvent(-1, "G_T5_B_ClipboardPaste")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 75
		Global $G_T5_B_OpenFile = GUICtrlCreateButton("Open File", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Open This File With Your Default Windows Text Editor")
		GUICtrlSetOnEvent(-1, "G_T5_B_OpenFile")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T5_B_OpenFolder = GUICtrlCreateButton("Open Folder", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Open The Folder Containing This File in Windows Explorer")
		GUICtrlSetOnEvent(-1, "G_T5_B_OpenFolder")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 85
		Global $G_T5_B_RestartUtil = GUICtrlCreateButton("Restart Util", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Restart This Utility Program: Servers Will Remain Running")
		GUICtrlSetOnEvent(-1, "G_TA_B_RestartUtil")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetBkColor(-1, $cGGridButtonActive)
		$tX += $tW + 5
		Global $G_T5_B_RestartServers = GUICtrlCreateButton("Restart Servers", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Restart Servers: You will be asked whether to restart servers now OR use Remote Restart with announcements.")
		GUICtrlSetOnEvent(-1, "G_TA_B_RestartServers")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		; -------------------------------------------------------------------
		...
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		Global $G_T6_L_GridName = GUICtrlCreateLabel("", 76, 73, 802, 24)
		GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
		GUICtrlSetColor(-1, 0x800000)
		GUICtrlSetBkColor(-1, 0xFFFFFF)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Global $G_T6_L_GridNumber = GUICtrlCreateLabel("", 20, 73, 49, 24)
		GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
		GUICtrlSetColor(-1, 0x800000)
		GUICtrlSetBkColor(-1, 0xFFFFFF)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Global $G_T6_E_Edit = GUICtrlCreateEdit("", 20, 137, 961, 449)
		GUICtrlSetOnEvent(-1, "G_T6_E_Edit")
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		GUICtrlSetBkColor(-1, $cFWBackground)
		_GUICtrlEdit_SetLimitText(-1, 999999)
		Local $tX = 20, $tW = 50, $tGap = 25
		Global $G_T6_B_Save = GUICtrlCreateButton("Save", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Click to save file: A backup will be made.")
		GUICtrlSetOnEvent(-1, "G_T6_B_Save")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T6_B_Reset = GUICtrlCreateButton("Reset", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Reset Edit Window: Reload contents from file.")
		GUICtrlSetOnEvent(-1, "G_T6_B_Reset")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		Global $G_T6_B_Find = GUICtrlCreateButton("Find", $tX, 105, $tW, 25)
		GUICtrlSetState(-1, $GUI_DISABLE)
		GUICtrlSetOnEvent(-1, "G_T6_B_Find")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
;~ 	HotKeySet("^f", "G_T6_H_Find")
		$tX += $tW + 5
		Global $G_T6_B_Replace = GUICtrlCreateButton("Replace", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Replace Text: New Window Asks for Text to be Replaced With New Text.")
		GUICtrlSetOnEvent(-1, "G_T6_B_Replace")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 110
		Global $G_T6_B_ClipboardCopy = GUICtrlCreateButton("Copy to Clipboard", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Copy Edit Window To Clipboard")
		GUICtrlSetOnEvent(-1, "G_T6_B_ClipboardCopy")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T6_B_ClipboardPaste = GUICtrlCreateButton("Paste from Clipboard", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Replace Edit Window Content With Clipboard")
		GUICtrlSetOnEvent(-1, "G_T6_B_ClipboardPaste")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 75
		Global $G_T6_B_OpenFile = GUICtrlCreateButton("Open File", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Open This File With Your Default Windows Text Editor")
		GUICtrlSetOnEvent(-1, "G_T6_B_OpenFile")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T6_B_OpenFolder = GUICtrlCreateButton("Open Folder", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Open The Folder Containing This File in Windows Explorer")
		GUICtrlSetOnEvent(-1, "G_T6_B_OpenFolder")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 85
		Global $G_T6_B_RestartUtil = GUICtrlCreateButton("Restart Util", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Restart This Utility Program: Servers Will Remain Running")
		GUICtrlSetOnEvent(-1, "G_TA_B_RestartUtil")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetBkColor(-1, $cGGridButtonActive)
		$tX += $tW + 5
		Global $G_T6_B_RestartServers = GUICtrlCreateButton("Restart Servers", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Restart Servers: You will be asked whether to restart servers now OR use Remote Restart with announcements.")
		GUICtrlSetOnEvent(-1, "G_TA_B_RestartServers")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		; -------------------------------------------------------------------
		...
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		Global $G_T7_L_GridName = GUICtrlCreateLabel("", 76, 73, 802, 24)
		GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
		GUICtrlSetColor(-1, 0x800000)
		GUICtrlSetBkColor(-1, 0xFFFFFF)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Global $G_T7_L_GridNumber = GUICtrlCreateLabel("", 20, 73, 49, 24)
		GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
		GUICtrlSetColor(-1, 0x800000)
		GUICtrlSetBkColor(-1, 0xFFFFFF)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Global $G_T7_E_Edit = GUICtrlCreateEdit("", 20, 137, 961, 449)
		GUICtrlSetOnEvent(-1, "G_T7_E_Edit")
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		GUICtrlSetBkColor(-1, $cFWBackground)
		_GUICtrlEdit_SetLimitText(-1, 999999)
		Local $tX = 20, $tW = 50, $tGap = 25
		Global $G_T7_B_Save = GUICtrlCreateButton("Save", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Click to save file: A backup will be made.")
		GUICtrlSetOnEvent(-1, "G_T7_B_Save")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T7_B_Reset = GUICtrlCreateButton("Reset", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Reset Edit Window: Reload contents from file.")
		GUICtrlSetOnEvent(-1, "G_T7_B_Reset")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		Global $G_T7_B_Find = GUICtrlCreateButton("Find", $tX, 105, $tW, 25)
		GUICtrlSetState(-1, $GUI_DISABLE)
		GUICtrlSetOnEvent(-1, "G_T7_B_Find")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
;~ 	HotKeySet("^f", "G_T7_H_Find")
		$tX += $tW + 5
		Global $G_T7_B_Replace = GUICtrlCreateButton("Replace", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Replace Text: New Window Asks for Text to be Replaced With New Text.")
		GUICtrlSetOnEvent(-1, "G_T7_B_Replace")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 110
		Global $G_T7_B_ClipboardCopy = GUICtrlCreateButton("Copy to Clipboard", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Copy Edit Window To Clipboard")
		GUICtrlSetOnEvent(-1, "G_T7_B_ClipboardCopy")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T7_B_ClipboardPaste = GUICtrlCreateButton("Paste from Clipboard", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Replace Edit Window Content With Clipboard")
		GUICtrlSetOnEvent(-1, "G_T7_B_ClipboardPaste")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 75
		Global $G_T7_B_OpenFile = GUICtrlCreateButton("Open File", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Open This File With Your Default Windows Text Editor")
		GUICtrlSetOnEvent(-1, "G_T7_B_OpenFile")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T7_B_OpenFolder = GUICtrlCreateButton("Open Folder", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Open The Folder Containing This File in Windows Explorer")
		GUICtrlSetOnEvent(-1, "G_T7_B_OpenFolder")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 85
		Global $G_T7_B_RestartUtil = GUICtrlCreateButton("Restart Util", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Restart This Utility Program: Servers Will Remain Running")
		GUICtrlSetOnEvent(-1, "G_TA_B_RestartUtil")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetBkColor(-1, $cGGridButtonActive)
		$tX += $tW + 5
		Global $G_T7_B_RestartServers = GUICtrlCreateButton("Restart Servers", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Restart Servers: You will be asked whether to restart servers now OR use Remote Restart with announcements.")
		GUICtrlSetOnEvent(-1, "G_TA_B_RestartServers")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		; -------------------------------------------------------------------
		...
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		Global $G_T8_L_GridName = GUICtrlCreateLabel("", 76, 73, 802, 24)
		GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
		GUICtrlSetColor(-1, 0x800000)
		GUICtrlSetBkColor(-1, 0xFFFFFF)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Global $G_T8_L_GridNumber = GUICtrlCreateLabel("", 20, 73, 49, 24)
		GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
		GUICtrlSetColor(-1, 0x800000)
		GUICtrlSetBkColor(-1, 0xFFFFFF)
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		Global $G_T8_E_Edit = GUICtrlCreateEdit("", 20, 137, 961, 449)
		GUICtrlSetOnEvent(-1, "G_T8_E_Edit")
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		GUICtrlSetBkColor(-1, $cFWBackground)
		_GUICtrlEdit_SetLimitText(-1, 999999)
		Local $tX = 20, $tW = 50, $tGap = 25
		Global $G_T8_B_Save = GUICtrlCreateButton("Save", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Click to save file: A backup will be made.")
		GUICtrlSetOnEvent(-1, "G_T8_B_Save")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T8_B_Reset = GUICtrlCreateButton("Reset", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Reset Edit Window: Reload contents from file.")
		GUICtrlSetOnEvent(-1, "G_T8_B_Reset")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		Global $G_T8_B_Find = GUICtrlCreateButton("Find", $tX, 105, $tW, 25)
		GUICtrlSetState(-1, $GUI_DISABLE)
		GUICtrlSetOnEvent(-1, "G_T8_B_Find")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
;~ 	HotKeySet("^f", "G_T8_H_Find")
		$tX += $tW + 5
		Global $G_T8_B_Replace = GUICtrlCreateButton("Replace", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Replace Text: New Window Asks for Text to be Replaced With New Text.")
		GUICtrlSetOnEvent(-1, "G_T8_B_Replace")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 110
		Global $G_T8_B_ClipboardCopy = GUICtrlCreateButton("Copy to Clipboard", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Copy Edit Window To Clipboard")
		GUICtrlSetOnEvent(-1, "G_T8_B_ClipboardCopy")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T8_B_ClipboardPaste = GUICtrlCreateButton("Paste from Clipboard", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Replace Edit Window Content With Clipboard")
		GUICtrlSetOnEvent(-1, "G_T8_B_ClipboardPaste")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 75
		Global $G_T8_B_OpenFile = GUICtrlCreateButton("Open File", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Open This File With Your Default Windows Text Editor")
		GUICtrlSetOnEvent(-1, "G_T8_B_OpenFile")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5
		Global $G_T8_B_OpenFolder = GUICtrlCreateButton("Open Folder", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Open The Folder Containing This File in Windows Explorer")
		GUICtrlSetOnEvent(-1, "G_T8_B_OpenFolder")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		$tX += $tW + 5 + $tGap
		$tW = 85
		Global $G_T8_B_RestartUtil = GUICtrlCreateButton("Restart Util", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Restart This Utility Program: Servers Will Remain Running")
		GUICtrlSetOnEvent(-1, "G_TA_B_RestartUtil")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		GUICtrlSetBkColor(-1, $cGGridButtonActive)
		$tX += $tW + 5
		Global $G_T8_B_RestartServers = GUICtrlCreateButton("Restart Servers", $tX, 105, $tW, 25)
		GUICtrlSetTip(-1, "Restart Servers: You will be asked whether to restart servers now OR use Remote Restart with announcements.")
		GUICtrlSetOnEvent(-1, "G_TA_B_RestartServers")
		GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
		; -------------------------------------------------------------------
		...
		Local $tX = 8
		For $i = 0 To ($aServerGridTotal - 1)
			$G_W_GridButtons[$i] = GUICtrlCreateButton(_ServerNamingScheme($i, $tNamingScheme), $tX, 8, 27, 25)
			GUICtrlSetResizing(-1, $GUI_DOCKLEFT + $GUI_DOCKTOP + $GUI_DOCKWIDTH + $GUI_DOCKHEIGHT)
	...
	If $G_LastTab = 1 Then ; Tab 2 GameUserSettings.ini
		If $tG_T2_EditClicked Then
			...
			ElseIf $tMB = 2 Or $tMB = -1 Then ; CANCEL or TIMEOUT
				Local $tTxt = GUICtrlRead($G_T2_E_EditGUS)
				GUICtrlSetState($G_T2_T_GUS, $GUI_SHOW)
				GUICtrlSetData($G_T2_E_EditGUS, $tTxt)
	...
	If $G_LastTab = 2 Then     ; Tab 3 Game.ini
		If $tG_T3_EditClicked Then
			...
			ElseIf $tMB = 7 Then ; NO
				...
				$tG_T3_EditClicked = False
			ElseIf $tMB = 2 Or $tMB = -1 Then ; CANCEL or TIMEOUT
				Local $tTxt = GUICtrlRead($G_T3_E_EditGame)
				GUICtrlSetState($G_T3_T_Game, $GUI_SHOW)
				GUICtrlSetData($G_T3_E_EditGame, $tTxt)
...
Func G_T2_UpdateTab()
	...
	GUICtrlSetData($G_T2_E_EditGUS, $tFileRead)
...
Func G_T2_B_Replace()
	...
	If $tMB = 1 Then ; OK
		...
		GUICtrlSetData($G_T2_E_EditGUS, $tTxt1)
		$tG_T2_EditClicked = True
...
Func G_T3_UpdateTab()
	...
	Local $tFileRead = FileRead($tFile)
	GUICtrlSetData($G_T3_E_EditGame, $tFileRead)
EndFunc   ;==>G_T3_UpdateTab
Func G_T3_E_EditGame()
	$tG_T3_EditClicked = True
;~ 	GUICtrlSetBkColor($G_T3_B_Save, $cGGridSaveButtonActive)
EndFunc   ;==>G_T3_E_EditGame
Func G_T3_B_Save()
...
Func G_T3_B_Replace()
	...
	If $tMB = 1 Then ; OK
		...
		Local $tTxt1 = StringReplace($tTxt, $tTxtBefore, $tTxtAfter)
		$tReplacements = @extended
		GUICtrlSetData($G_T3_E_EditGame, $tTxt1)
		$tG_T3_EditClicked = True
		_Splash($tReplacements & " occurrences were replaced", 2000)
	Else
		_Splash("Replace canceled.", 1500)
...
Func G_T3_B_ClipboardCopy()
	ClipPut(GUICtrlRead($G_T3_E_EditGame))
	_Splash("Contents copied to clipboard", 750)
EndFunc   ;==>G_T3_B_ClipboardCopy
Func G_T3_B_ClipboardPaste()
	GUICtrlSetData($G_T3_E_EditGame, ClipGet())
