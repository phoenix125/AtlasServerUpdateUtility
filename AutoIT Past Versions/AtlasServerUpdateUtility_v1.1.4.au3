...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.1.4.exe
...
#AutoIt3Wrapper_Res_ProductVersion=v1.1.4
...
; All Servers
$aUtilVersion = "v1.1.4" ; (2019-02-18)
...
If $aServerGridTotal <> (UBound($xServerAltSaveDir) - 1) And $xServerAltSaveDir <> "" Then
	SplashOff()
...
Func ReadUini($sIniFile, $sLogFile)
	...
	Global $aServerRCONPort = IniRead($sIniFile, " --------------- GAME SERVER CONFIGURATION --------------- ", "Server RCON Port(s) (comma separated, grid order left-to-right) ###", $iniCheck)
...
Func UpdateIni($sIniFile)
	...
	IniWrite($sIniFile, " --------------- GAME SERVER CONFIGURATION --------------- ", "Server RCON Port(s) (comma separated, grid order left-to-right) ###", $aServerRCONPort)
