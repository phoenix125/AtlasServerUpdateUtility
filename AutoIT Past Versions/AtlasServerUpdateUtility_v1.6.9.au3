...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.6.9.exe
#AutoIt3Wrapper_Outfile_x64=Builds\AtlasServerUpdateUtility_v1.6.9_64-bit(x64).exe
#AutoIt3Wrapper_Compile_Both=y
#AutoIt3Wrapper_UseX64=y
#AutoIt3Wrapper_Res_Comment=By Phoenix125 based on Dateranoth's ConanServerUtility v3.3.0-Beta.3
#AutoIt3Wrapper_Res_Description=Atlas Dedicated Server Update Utility
#AutoIt3Wrapper_Res_Fileversion=1.6.9.0
#AutoIt3Wrapper_Res_ProductName=AtlasServerUpdateUtility
#AutoIt3Wrapper_Res_ProductVersion=v1.6.9
...
$aUtilVerStable = "v1.6.9" ; (2019-06-05)
$aUtilVerBeta = "v1.6.9" ; (2019-06-05)
...
Local $tMsg = "NOTICE!!! starting v1.6.9 !!! " & @CRLF & @CRLF & _
...
Func _BackupGame($tMinimizeTF = True)
	...
	EndIf
	Local $tCMD = """" & $aFolderTemp & "7z"" a -r -tzip -ssw -x!ocean.*.atlas """ & $tFull & """ """ & $aServerDirLocal & "\ShooterGame\Saved\"" """ & $aServerDirLocal & "\ShooterGame\Server*.json""" & $tRedis
