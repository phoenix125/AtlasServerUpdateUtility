...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.4.2.exe
...
#AutoIt3Wrapper_Res_ProductVersion=v1.4.2
...
SplashTextOn($aUtilName, $aUtilName & " started.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
FileWriteLine($aLogFile, _NowCalc() & " ============================ " & $aUtilName & " " & $aUtilVersion & " Started ============================")
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Checking for running server and redis processes.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Importing settings from " & $aIniFile & ".", 400, 110, -1, -1, $DLG_MOVEABLE, "")
...
EndIf
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Importing settings from " & $aConfigFile & ".", 400, 110, -1, -1, $DLG_MOVEABLE, "")
ImportConfig($aServerDirLocal, $aConfigFile)
$aTelnetPass = $aServerAdminPass
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Importing settings from " & $aGridFile & ".", 400, 110, -1, -1, $DLG_MOVEABLE, "")
GridStartSelect($aGridFile, $aLogFile)
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Preparing server startup scripts.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
...
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Checking for existance of external files.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
FileExistsFunc()
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Checking for existance of external scripts (if enabled).", 400, 110, -1, -1, $DLG_MOVEABLE, "")
ExternalScriptExist()
If $aRemoteRestartUse = "yes" Then
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Initializing Remote Restart.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
TCPStartup()
...
$aErrorMsg = "!!! CRITICAL ERROR !!! Server STOPPED." & @CRLF & @CRLF & "SteamCMD update and/or the first grid server failed three times in a row." & @CRLF & "Check your server config. You may need to backup your data, delete your " & $aGameName & " folder, rerun this utility to reinstall your server files, then restore your data."
...
If $aFirstBoot Then
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Acquiring latest buildid from SteamDB.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
EndIf
Local $aLatestVersion = GetLatestVerSteamDB($aSteamAppID, $aServerVer)
Else
If $aFirstBoot Then
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Acquiring latest buildid from SteamCMD.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
EndIf
Local $aLatestVersion = GetLatestVersion($aSteamCMDDir)
EndIf
If $aFirstBoot Then
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Retrieving installed version buildid.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
EndIf
...
EndIf
Else
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Waiting for BEFORE SteamCMD UPDATE AND SERVER START external script to finish . . .", 400, 110, -1, -1, $DLG_MOVEABLE, "")
If $aExternalScriptHideYN = "yes" Then
...
EndIf
Else
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Waiting for AFTER SteamCMD BUT BEFORE SERVER external script to finish . . .", 400, 110, -1, -1, $DLG_MOVEABLE, "")
If $aExternalScriptHideYN = "yes" Then
...
EndIf
Else
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Waiting for DAILY external script to finish . . .", 400, 110, -1, -1, $DLG_MOVEABLE, "")
If $aExternalScriptHideYN = "yes" Then
...
EndIf
Else
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Waiting for FIRST ANNOUNCEMENT external script to finish . . .", 400, 110, -1, -1, $DLG_MOVEABLE, "")
If $aExternalScriptHideYN = "yes" Then
...
EndIf
Else
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Waiting for REMOTE RESTART external script to finish . . .", 400, 110, -1, -1, $DLG_MOVEABLE, "")
If $aExternalScriptHideYN = "yes" Then
...
EndIf
Else
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Waiting for Script When Restarting For Server Update external script to finish . . .", 400, 110, -1, -1, $DLG_MOVEABLE, "")
If $aExternalScriptHideYN = "yes" Then
...
EndIf
Else
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Waiting for Script When Restarting For MOD Update external script to finish . . .", 400, 110, -1, -1, $DLG_MOVEABLE, "")
If $aExternalScriptHideYN = "yes" Then
...
#EndRegion
#Region
Func AnnounceReplaceModID($tMod, $tMsg0, $tTime0)
...
Local $tMsg1 = $tTime3
For $tTime2 = 1 To $tTime3[0]
$tMsg1[$tTime2] = StringReplace($tMsg0[$tTime2], "\x", $tMod)
Next
Return $tMsg1
EndIf
EndFunc
...
If $sFileExists = 0 Then
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Downloading AtlasModDownloader.exe.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
...
$xError = True
FileWriteLine($aLogFile, _NowCalc() & " [Mod] Something went wrong downloading update information for mod [" & $aMods[$i] & "] If running Windows Server, Disable ""IE Enhanced Security Configuration"" for Administrators (via Server Manager > Local Server > IE Enhanced Security Configuration).")
ElseIf Not $aInstalledTime[0] Then
$bStopUpdate = UpdateMod($aMods[$i], $aModName[$i], $sSteamCmdDir, $sServerDir, 0)
If $bStopUpdate Then ExitLoop
ElseIf Not $aInstalledTime[1] Then
$bStopUpdate = UpdateMod($aMods[$i], $aModName[$i], $sSteamCmdDir, $sServerDir, 1)
If $bStopUpdate Then ExitLoop
ElseIf $aInstalledTime[1] And (StringCompare($aLatestTime[2], $aInstalledTime[2]) <> 0) Then
$xError = True
$bStopUpdate = UpdateMod($aMods[$i], $aModName[$i], $sSteamCmdDir, $sServerDir, 2)
If $bStopUpdate Then ExitLoop
EndIf
Next
...
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Checking for mod " & $sMod & " update or new mod.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
EndIf
...
If $aFirstModCheck Then
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Checking for installed version of mod" & @CRLF & $sMod & " " & $sModName, 400, 110, -1, -1, $DLG_MOVEABLE, "")
EndIf
...
Return $aReturn
EndFunc
Func UpdateMod($sMod, $sModName, $sSteamCmdDir, $sServerDir, $iReason)
Local $bReturn = False
...
EndIf
$aModMsgInGame = AnnounceReplaceModID($sMod, $sModMsgInGame, $sAnnounceNotifyModUpdate)
$aModMsgDiscord = AnnounceReplaceModID($sMod, $sModMsgDiscord, $sAnnounceNotifyModUpdate)
$aModMsgTwitch = AnnounceReplaceModID($sMod, $sModMsgTwitch, $sAnnounceNotifyModUpdate)
RunWait($aModScript)
...
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Checking for " & $tUtilName & " updates.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
Local $tVer[2]
...
$xStartGrid[$i] = "no "
EndIf
FileWriteLine($tServerSummaryFile, "[Server " & $xServergridx[$i] & $xServergridy[$i] & "] Use:" & $xStartGrid[$i] & ", QueryPort:" & $xServerport[$i] & ", Port:" & $xServergameport[$i] & ", SeamlessIP:" & $xServerIP[$i] & ", RCON:" & $xServerRCONPort[$i + 1] & ", DIR:a" & $xServergridx[$i] & $xServergridy[$i])
Next
Else
For $i = 0 To ($aServerGridTotal - 1)
If $xStartGrid[$i] = "no" Then
$xStartGrid[$i] = "no "
EndIf
FileWriteLine($tServerSummaryFile, " [Server " & $xServergridx[$i] & $xServergridy[$i] & "] Use:" & $xStartGrid[$i] & " QueryPort:" & $xServerport[$i] & ", Port:" & $xServergameport[$i] & ", SeamlessIP:" & $xServerIP[$i] & ", RCON:" & $xServerRCONPort[$i + 1] & ", DIR:" & $xServerAltSaveDir[$i])
Next
EndIf
Local $aWAN = _GetIP()
...
$tDIR = $tDIR & "a" & $xServergridx[$i] & $xServergridy[$i] & ","
Next
$tDIR = $tDIR & "a" & $xServergridx[$aServerGridTotal - 1] & $xServergridy[$aServerGridTotal - 1]
Else
For $i = 0 To ($aServerGridTotal - 2)
...
If $aRemoteRestartUse <> "yes" Then
$tMB = MsgBox($MB_YESNOCANCEL, $aUtilName, "You must enable Remote Restart in the " & $aUtilName & ".ini." & @CRLF & @CRLF & "Would you like to enable it? (Port:" & $aRemoteRestartPort & ")" & @CRLF & "Click (YES) to enable Remote Restart. A utility restart will be required (including shutting down all servers. COMING SOON, this will not be required)" & @CRLF & "Click (NO) or (CANCEL) to skip.", 15)
If $tMB = 6 Then
...
If $tMB = 2 Then
FileWriteLine($aLogFile, _NowCalc() & " [Remote RCON] Broadcast message cancelled by user.")
SplashTextOn($aUtilName, "Broadcast Message cancelled. Resuming utility . . .", 400, 110, -1, -1, $DLG_MOVEABLE, "")
Sleep(2000)
Else
...
SplashOff()
If $aGridSomeDisable Then
$tMB = MsgBox($MB_YESNOCANCEL, $aUtilName, "Send Send RCON command to ALL servers, including disabled ones in GridStartSelect?" & @CRLF & @CRLF & "Click (YES) to send RCON command to ALL servers." & @CRLF & "Click (NO) to send to LOCAL hosted servers (only ones marked ""yes"" in GridStartSelect)." & @CRLF & "Click (CANCEL) to cancel.", 15)
If $tMB = 2 Then
FileWriteLine($aLogFile, _NowCalc() & " [Remote RCON] Send RCON command cancelled by user.")
SplashTextOn($aUtilName, "Send RCON command cancelled. Resuming utility . . .", 400, 110, -1, -1, $DLG_MOVEABLE, "")
Sleep(2000)
Else
...
If $tTmp = -1 Then
$tReturn = "0"
FileWriteLine($aLogFile, _NowCalc() & " Redis Server NOT running or file not found.")
Else
$tReturn = FileRead($tTmp)
FileClose($tTmp)
If ProcessExists($tReturn) Then
FileWriteLine($aLogFile, _NowCalc() & " Redis Server PID(" & $tReturn & ") found.")
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Redis Server found." & @CRLF & "PID:(" & $tReturn & ")", 400, 110, -1, -1, $DLG_MOVEABLE, "")
Sleep(1500)
Else
$tReturn = "0"
EndIf
...
If $tTmp = -1 Then
$tReturn[0] = "0"
FileWriteLine($aLogFile, _NowCalc() & " Grid Server(s) NOT running or file not found.")
Else
...
Next
SplashTextOn($aUtilName, $aUtilName & " started." & @CRLF & @CRLF & "Running servers found." & @CRLF & "PID:(" & $tString & ")", 400, 110, -1, -1, $DLG_MOVEABLE, "")
Sleep(2500)
For $i = 0 To $n
