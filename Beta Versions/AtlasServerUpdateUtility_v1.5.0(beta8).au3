...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.5.0(beta8).exe
...
$aUtilVerBeta = "v1.5.0(beta8)" ; (2019-03-26)
...
;~ 	$aServerPID = ResizeArray($aServerPID)
	Global $aServerPI_Stripped = ResizeArray($aServerPID)
