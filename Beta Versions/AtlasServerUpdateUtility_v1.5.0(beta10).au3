...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.5.0(beta10).exe
...
$aUtilVerBeta = "v1.5.0(beta10)" ; (2019-03-26)
...
Global $aSplashStartUp = SplashTextOn($aUtilName, $aStartText, 400, 110, -1, -1, $DLG_MOVEABLE, "")
...
Func CheckMod($sMods, $sSteamCmdDir, $sServerDir)
	...
	If $aFirstModCheck Then
		Global $aSplashMod = SplashTextOn($aUtilName, $aStartText & "Checking for mod updates.", 400, 110, -1, -1, $DLG_MOVEABLE, "")
	EndIf
...
;~ 		SplashTextOn($aUtilName, $aUtilName & " " & $aUtilVersion & " started." & @CRLF & @CRLF & "Checking for installed version of mod" & @CRLF & $sMod & " " & $sModName, 400, 110, -1, -1, $DLG_MOVEABLE, "")
		ControlSetText($aSplashMod, "", "Static1", $aStartText & "Checking for installed version of mod" & @CRLF & $sMod & " " & $sModName)
	EndIf
