...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.5.0(beta21)_32bit(x86).exe
#AutoIt3Wrapper_Outfile_x64=Builds\AtlasServerUpdateUtility_v1.5.0(beta21).exe
...
$aUtilVerBeta = "v1.5.0(beta21)" ; (2019-04-20)
Global $aUtilVerNumber = 1 ; 0 = v1.5.0(beta19/20), 1 = v1.5.0(beta21)
