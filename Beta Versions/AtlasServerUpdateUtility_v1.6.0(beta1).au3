...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.6.0(beta1).exe
#AutoIt3Wrapper_Outfile_x64=Builds\AtlasServerUpdateUtility_v1.6.0(beta1)_64-bit(x64).exe
...
$aUtilVerStable = "v1.5.8" ; (2019-05-16)
$aUtilVerBeta = "v1.6.0(beta1)" ; (2019-05-17)
...
Func GUI_Log_ServerGrid_B_Save()
	...
	_Splash($aUtilName, $aConfigFile & " updated." & @CRLF & @CRLF & "Backup created: " & @CRLF & $aConfigFile & "_" & $tTime & ".bak", 3000, 525)
...
;~ 					$aRCONError = False
				...
				Else
					...
					Next
					If $tUsers < 0 Then
						LogWrite(" [Online Players] Error receiving online players from Server: " & _ServerNamingScheme($i, $aNamingScheme))
						$aErr = True
;~ 						$aRCONError = False
						$aServerPlayers[$i] = -2
						$tOnlinePlayers[1] = $tOnlinePlayers[1] & _ServerNamingScheme($i, $aNamingScheme) & "(-), "
