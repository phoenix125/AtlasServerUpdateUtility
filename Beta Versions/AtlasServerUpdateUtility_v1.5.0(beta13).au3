...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.5.0(beta13).exe
...
$aUtilVerBeta = "v1.5.0(beta13)" ; (2019-04-09)
...
;~		GUICtrlSetColor($gPollRemoteServersLabel, 0x212121) ;Kim!!!
;~ 	EndIf
;~ 	Local $tTotalPlayers = 0
;~ 	Local $tTotalPlayerError = False
;~ 	For $i = 0 To ($aServerGridTotal - 1)
