...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.5.0(beta17).exe
...
$aUtilVerBeta = "v1.5.0(beta17)" ; (2019-04-12)
...
Func GUI_Log_Basic_B_Button()
	...
	GUICtrlSetData($lBasicEdit, FileRead($aFile))
...
Func GUI_Log_Detailed_B_Button()
	...
	GUICtrlSetData($lDetailedEdit, FileRead($aFile))
...
Func GUI_Log_OnlinePlayers_B_Button()
	...
	GUICtrlSetData($lOnlinePlayersEdit, FileRead($aFile))
EndFunc   ;==>GUI_Log_OnlinePlayers_B_Button
Func GUI_Log_ServerSummary_B_Button()
	GUICtrlSetData($lServerSummaryEdit, FileRead($aServerSummaryFile))
...
Func GUI_Log_Config_B_Reset()
	GUICtrlSetData($lConfigEdit, FileRead($aIniFile))
EndFunc   ;==>GUI_Log_Config_B_Reset
Func GUI_Log_GridSelect_B_Save()
	Local $tTxt = GUICtrlRead($lGridSelectEdit)
	Local $tTime = @YEAR & "-" & @MON & "-" & @MDAY & "_" & @HOUR & "-" & @MIN
...
Func GUI_Log_GridSelect_B_Reset()
	GUICtrlSetData($lGridSelectEdit, FileRead($aGridSelectFile))
EndFunc   ;==>GUI_Log_GridSelect_B_Reset
Func GUI_Log_ServerGrid_B_Save()
	Local $tTxt = GUICtrlRead($lServerGridEdit)
	Local $tTime = @YEAR & "-" & @MON & "-" & @MDAY & "_" & @HOUR & "-" & @MIN
...
Func GUI_Log_ServerGrid_B_Reset()
	GUICtrlSetData($lServerGridEdit, FileRead($aConfigFull))
EndFunc   ;==>GUI_Log_ServerGrid_B_Reset
Func GUI_Log_DefaultGame_B_Save()
	Local $tTxt = GUICtrlRead($lDefaultGameEdit)
	Local $tTime = @YEAR & "-" & @MON & "-" & @MDAY & "_" & @HOUR & "-" & @MIN
...
Func GUI_Log_DefaultGame_B_Reset()
	GUICtrlSetData($lDefaultGameEdit, FileRead($aDefaultGame))
EndFunc   ;==>GUI_Log_DefaultGame_B_Reset
Func GUI_Log_DefaultGUS_B_Save()
	Local $tTxt = GUICtrlRead($lDefaultGUSEdit)
	Local $tTime = @YEAR & "-" & @MON & "-" & @MDAY & "_" & @HOUR & "-" & @MIN
...
Func GUI_Log_DefaultGUS_B_Reset()
	GUICtrlSetData($lDefaultGUSEdit, FileRead($aDefaultGUS))
EndFunc   ;==>GUI_Log_DefaultGUS_B_Reset
Func GUI_Log_DefaultEngine_B_Save()
	Local $tTxt = GUICtrlRead($lDefaultEngineEdit)
	Local $tTime = @YEAR & "-" & @MON & "-" & @MDAY & "_" & @HOUR & "-" & @MIN
...
Func GUI_Log_DefaultEngine_B_Reset()
	GUICtrlSetData($lDefaultEngineEdit, FileRead($aDefaultEngine))
...
;~ 			For $i = 0 To UBound($tReturn - 1)
			...
			If $tPID <> "" Then
				If $aUtilReboot = "no" And ((_DateDiff('n', $aCFGLastUpdate, _NowCalc())) >= $aUpdateCheckInterval) Then
					...
					Local $tTxt = $aStartText & UBound($aTmp) & " Running servers found." & @CRLF & "PID:(" & StringTrimRight($tPID, 1) & ")"
					If $tSplash > 0 Then
						ControlSetText($tSplash, "", "Static1", $tTxt)
					Else
						SplashTextOn($aUtilName, $tTxt, 400, 110, -1, -1, $DLG_MOVEABLE, "")
...
;~ 		WinSetOnTop($LogWindow, "", 1)
	Else
		...
		Global $lBasicEdit = GUICtrlCreateEdit("", 12, 73, ($lWidth - 25), ($lHeight - 90), BitOR($ES_READONLY, $WS_HSCROLL, $WS_VSCROLL))
		GUICtrlSetData($lBasicEdit, FileRead($aLogFile))
		...
		Global $lDetailedEdit = GUICtrlCreateEdit("", 12, 73, ($lWidth - 25), ($lHeight - 90), BitOR($ES_READONLY, $WS_HSCROLL, $WS_VSCROLL))
		GUICtrlSetData($lDetailedEdit, FileRead($aLogDebugFile))
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		...
		Global $lOnlinePlayersEdit = GUICtrlCreateEdit("", 12, 73, ($lWidth - 25), ($lHeight - 90), BitOR($ES_READONLY, $WS_HSCROLL, $WS_VSCROLL))
		GUICtrlSetData($lOnlinePlayersEdit, FileRead($aOnlinePlayerFile))
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		...
		Global $lServerSummaryEdit = GUICtrlCreateEdit("", 12, 73, ($lWidth - 25), ($lHeight - 90), BitOR($ES_READONLY, $WS_HSCROLL, $WS_VSCROLL))
		GUICtrlSetData($lServerSummaryEdit, FileRead($aServerSummaryFile))
		...
		Global $lConfigEdit = GUICtrlCreateEdit("", 12, 73, ($lWidth - 25), ($lHeight - 90), BitOR($WS_HSCROLL, $WS_VSCROLL, $ES_WANTRETURN, $ES_MULTILINE))
		GUICtrlSetData($lConfigEdit, FileRead($aIniFile))
		GUICtrlSetFont(-1, 9, 400, 0, "Courier New")
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		...
		Global $lGridSelectEdit = GUICtrlCreateEdit("", 12, 73, ($lWidth - 25), ($lHeight - 90), BitOR($WS_HSCROLL, $WS_VSCROLL, $ES_WANTRETURN, $ES_MULTILINE))
		GUICtrlSetData($lGridSelectEdit, FileRead($aGridSelectFile))
		GUICtrlSetFont(-1, 9, 400, 0, "Courier New")
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		...
		Global $lServerGridEdit = GUICtrlCreateEdit("", 12, 73, ($lWidth - 25), ($lHeight - 90), BitOR($WS_HSCROLL, $WS_VSCROLL, $ES_WANTRETURN, $ES_MULTILINE))
		GUICtrlSetData($lServerGridEdit, FileRead($aConfigFull))
		GUICtrlSetFont(-1, 9, 400, 0, "Courier New")
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		...
		Global $lDefaultGameEdit = GUICtrlCreateEdit("", 12, 73, ($lWidth - 25), ($lHeight - 90), BitOR($WS_HSCROLL, $WS_VSCROLL, $ES_WANTRETURN, $ES_MULTILINE))
		GUICtrlSetData($lDefaultGameEdit, FileRead($aDefaultGame))
		GUICtrlSetFont(-1, 9, 400, 0, "Courier New")
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		...
		Global $lDefaultGUSEdit = GUICtrlCreateEdit("", 12, 73, ($lWidth - 25), ($lHeight - 90), BitOR($WS_HSCROLL, $WS_VSCROLL, $ES_WANTRETURN, $ES_MULTILINE))
		GUICtrlSetData($lDefaultGUSEdit, FileRead($aDefaultGUS))
		GUICtrlSetFont(-1, 9, 400, 0, "Courier New")
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
		...
		Global $lDefaultEngineEdit = GUICtrlCreateEdit("", 12, 73, ($lWidth - 25), ($lHeight - 90), BitOR($WS_HSCROLL, $WS_VSCROLL, $ES_WANTRETURN, $ES_MULTILINE))
		GUICtrlSetData($lDefaultEngineEdit, FileRead($aDefaultEngine))
		GUICtrlSetFont(-1, 9, 400, 0, "Courier New")
		GUICtrlSetResizing(-1, $GUI_DOCKAUTO + $GUI_DOCKTOP + $GUI_DOCKHCENTER + $GUI_DOCKVCENTER)
