...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.5.0(beta24)_32bit(x86).exe
#AutoIt3Wrapper_Outfile_x64=Builds\AtlasServerUpdateUtility_v1.5.0(beta24).exe
...
$aUtilVerBeta = "v1.5.0(beta24)" ; (2019-04-25)
Global $aUtilVerNumber = 2 ; 0 = v1.5.0(beta19/20), 1 = v1.5.0(beta21/22/23), 2=v1.5.0(beta24)
