...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.5.0(beta19)_32bit(x86).exe
#AutoIt3Wrapper_Outfile_x64=Builds\AtlasServerUpdateUtility_v1.5.0(beta19).exe
...
$aUtilVerBeta = "v1.5.0(beta19)" ; (2019-04-14)
...
#cs
	SplashOff()
	$aRunWiz = MsgBox($MB_YESNOCANCEL, "Kim", "Run Setup Wizard?")
...
Func WizardNew()
	MsgBox(0, "Kim", "New Install Coming Soon!", 10)
EndFunc   ;==>WizardNew
