...
#AutoIt3Wrapper_Outfile=Builds\AtlasServerUpdateUtility_v1.5.0(beta23)_32bit(x86).exe
#AutoIt3Wrapper_Outfile_x64=Builds\AtlasServerUpdateUtility_v1.5.0(beta23).exe
...
$aUtilVerBeta = "v1.5.0(beta23)" ; (2019-04-21)
Global $aUtilVerNumber = 1 ; 0 = v1.5.0(beta19/20), 1 = v1.5.0(beta21/22/23)
...
GUIRegisterMsg($WM_SIZE, "_WM_SIZE") ;Kim!!!
	...
	If TimerDiff($aServerCheck) > 10000 Then
				...
				Case 0
					...
					If $aBeginDelayedShutdown = 0 Then
						...
						Else
							...
							CloseServer($aServerIP, $aTelnetPort, $aTelnetPass, False) ; Do NOT restart redis.
						EndIf
					EndIf
				Case 1 To 4
		...
		If (($aRestartDaily = "yes") And ((_DateDiff('n', $aTimeCheck2, _NowCalc())) >= 1) And (DailyRestartCheck($aRestartDays, $aRestartHours, $aRestartMin)) And ($aBeginDelayedShutdown = 0)) Then
			...
			Else
				...
				CloseServer($aServerIP, $aTelnetPort, $aTelnetPass, False)
			EndIf
			;		EndIf
